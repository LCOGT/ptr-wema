...
wema_config = {
    ...
    'name': 'Testing Burnir Observatory',
    ...
    'latitude': -30.063610,     #  Decimal degrees, North is Positive
    'longitude': 30.875275,   #  Decimal degrees, West is negative
    ...
    'enclosure': {
        'enclosure1': {
            ...
            'name': 'Dragonfly Roof',
            'hostIP':  None,
            'driver': 'dummy',  #'ASCOM.DigitalDomeWorks.Dome',  #  ASCOMDome.Dome',  #  ASCOM.DeviceHub.Dome',  #  ASCOM.DigitalDomeWorks.Dome',  #"  ASCOMDome.Dome',
            'has_lights':  False,
