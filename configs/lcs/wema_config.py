...
wema_config = {
    ...
    'wema_hostname': 'LCC-WMS-ENC',   # Prefer the shorter version
    ...
    'host_wema_site_name':  'LCC',  # The umbrella header for obsys in close geographic proximity,
                                    #  under the control of one wema
    'name': 'Luther College observatory - Croydon',
    'airport_code':  'MEL: Melbourne Airport',
    'location': 'Croydon, Victoria, Australia',
    'telescope_description': 'n.a.',
    'observatory_url': 'https://www.luther.vic.edu.au/',   #  This is meant to be optional
    'observatory_logo': None,   # I expect these will ususally end up as .png format icons
    'description':  '''Luther College''',    #  i.e, a multi-line text block supplied and eventually mark-up formatted by the owner.
    ...
    'latitude': -37.7827,     #  Decimal degrees, North is Positive
    'longitude': 145.2702,   #  Decimal degrees, West is negative
