...
site_config = {
    ...
    'site_latitude': -37.70097222,     #  Decimal degrees, North is Positive
    'site_longitude': 145.1918056,   #  Decimal degrees, West is negative
    'site_elevation': 150,    #  meters above sea level
