...
wema_config = {
    ...
    'obsp_ids': ['ssco1'],  # a list of the obsp's in an enclosure.  
    ...
    'name': 'Saeed Salimpour Cosmological Observatory',
    'airport_code':  'MEL: Melbourne Airport',
    'location': 'Clunes, Victoria, Australia',
    'telescope_description': 'n.a.',
    'observatory_url': 'https://nextastro.org/',   #  This is meant to be optional
    ...
    'latitude': -37.29738667896441,     #  Decimal degrees, North is Positive
    'longitude':  143.7697427041909,   #  Decimal degrees, West is negative ,
    ...
    'observing_conditions' : {
        'observing_conditions1': {
            ...
            'aagsolo_rain_threshold': 1500,
            'aagsolo_clear_skyT': -20,
            'aagsolo_cloudy_skyT': 3,
