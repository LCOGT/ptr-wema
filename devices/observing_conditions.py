    ...
    def get_status(self):
        ...
        #DO NOT RELY ON THE BOLTWOOD FOR SKY TEMP
            ...
            try:
                ...
                self.sky_minus_ambient = round(self.sky_temp - self.temperature ,1)
...
# =======
#                     sky_gap = True   <<<THE above is hangover code and probably useless WER
                ...
                self.wx_is_ok = not (
                    ...
                    or sky_gap
                    or temp_gap
                    or cloud_gap  #THsi signal always false.
                )
